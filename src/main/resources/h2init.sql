...
INSERT INTO wishlist(Userid, Name)
VALUES (1, 'Julegaver'),
       (2, 'Fødselsdag'),
       (3, 'Fødselsdag'),
       (4, 'Julegaver');

INSERT INTO wish(Name, Description, Link, Price, Wishlistid)
VALUES ('Air Jordans', 'De vildeste kicks', 'www.Nike/airjoardans.com', 1500, 1),
